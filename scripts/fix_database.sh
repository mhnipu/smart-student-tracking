...
echo -e "\033[0;36mRunning the database fix script...\033[0m"
...
TARGET_SCRIPT="$SCRIPT_DIR/../supabase/scripts/fix_database.sh"
...
if [ -f "$TARGET_SCRIPT" ]; then
    ...
    echo -e "\033[0;31mError: Could not find the database fix script at: $TARGET_SCRIPT\033[0m"
